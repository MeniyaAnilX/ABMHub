...
const categories: Category[] = ["DeFi", "L1", "L2", "Bridge", "ZK", "DEX", "Lending", "Infra", "NFT", "Gaming", "AI"];
const phases: ProjectPhase[] = ["Testnet", "Mainnet", "Both", "Waitlist"];
const statuses: ProjectStatus[] = ["Live", "Trending", "Ended"];
const chains: Chain[] = ["Ethereum", "Optimism", "Arbitrum", "Base", "Solana", "Sui", "Other"];
...
export default function AdminPage() {
  ...
  useEffect(() => {
    async function checkAuth() {
      ...
      if (error) {
        setMessage("Admin permission check failed: " + error.message + ". Run ABMHUB_V6_ADMIN_REALTIME_RATING_FIX.sql in Supabase.");
      ...
      <main className="app-shell">
        <div className="mb-4 flex items-center justify-between gap-3 max-sm:flex-col max-sm:items-stretch">
          <div>
            ...
            <p className="text-sm text-slate-400">Add, edit, delete projects and upload logos. Public users cannot access these actions.</p>
          </div>
